...
public class JwtAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    private static final List<String> WEB_PATHS = List.of(
            ...
            "/ir/aspireapps/linker/auth/web/v1/logout",
            "/ir/aspireapps/linker/user/web/v1/addLink",
            "/ir/aspireapps/linker/user/web/v1/toggle",
            "/ir/aspireapps/linker/user/web/v1/delete"
    );
    ...
    private Mono<Void> redirectToRefresh(ServerWebExchange exchange, String refreshToken) {
        UserRefreshRequest refreshRequest = UserRefreshRequest.builder()
                ...
                .build();
        String redirectPath = "http://user-service/linker/auth/web/v1/refresh";
